...
int visited[20];
int availables[10][2];
char *name[20]={"Arad", "Bucharest" , "Craiova", "Dobreta", "Eforie", "Fagarus", "Giurgiu", "Hirsova", "Lasi", "Lugoj", "Mehadia", "Neamt", "Oradea", "Pitesti", "RimnicuVilcea", "Sibeu", "Timisora", "Urziceni", "Valsui", "Zerind"};
;
